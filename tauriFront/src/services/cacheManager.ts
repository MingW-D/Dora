...
export interface MessageContentBlock {
  type: 'text' | 'tool_call' | 'url_links' | 'plan_steps' | 'step_result' | 'tool_message' | 'task' | 'subtask_status' | 'final_result' | 'html_report' | 'htmlReport' | 'user_agent' | 'assistant_agent' | 'video_search';
